...
export const DEFAULT_CADENCE: CadenceRule[] = [
  { stage: 'day_3', daysAfterPrevious: 3, channels: ['sms'], template: 'check_in', priority: 10 },
  { stage: 'day_7', daysAfterPrevious: 4, channels: ['sms', 'email'], template: 'market_update', priority: 9 },
  { stage: 'day_14', daysAfterPrevious: 7, channels: ['sms'], template: 'new_listing_alert', priority: 8 },
